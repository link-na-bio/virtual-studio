...
const PACOTES_INFO: Record<string, { nome: string, preco: number, fotos: number, icon: any }> = {
  // Nota: Mantemos as chaves 'basico', 'popular' e 'pro' minúsculas pois é assim que estão salvas no banco de dados atualmente, mas mudamos o nome de exibição.
  ...
  // Fallback caso venha com o nome exato do front
